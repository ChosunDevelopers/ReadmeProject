...
<br>
<h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">찜한 개발자</h2>
<!-- Icon Divider-->
...
<div class="container">
	...
	<c:forEach var = "pickTeammate" items="${pickTeammate}">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <div class="content-text">
                    <h5 class="card-title">${pickTeammate.name}</h5>
                    <h6 class="card-subtitle mb-2">${pickTeammate.id }</h6>
                </div>
            </div>
            <p class="card-text">${pickTeammate.skill }</p>
            <div class="more">
                <a href="/memberSearch/memberDetail/${pickTeammate.id }" class="card-link" style="float:right">더보기</a>
            </div>                    
        </div>
    </c:forEach>    
    </div>
